      ...
      <section className=' zinc-bg text-white  px-36'>
        <Scrolln>
          <div className='container mx-auto pb-14 pt-4'>
            <h1 className='text-[10px] color'><Link href='/' className='hover:underline'>home</Link>  <span className="mx-2">{`//`}</span>  <Link href='/services' className='hover:underline'>Our Services</Link>  <span className="mx-2">{`//`}</span>   <span className='yellow-text font-bold '>UI/UX</span>  </h1>
            <div className='text-5xl pt-8'>

              <h1 className='mt-4 font-[500]'>  UI-UX<YellowDot />
              </h1>
        ...
        <Scrolln width='100%'>
          ...
          <div className='container mx-auto flex justify-center gap-9 items-center mt-10'>
            <div className='w-6/12 flex justify-end'>
              <Image
                src={'/assets/serviceImgs/UIUX.svg'}
                height={500}
                width={400}
                alt='UI/UX services by TechSavy Group'
