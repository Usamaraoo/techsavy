      ...
      <section className=' zinc-bg text-white  px-36'>
        <Scrolln>
          <div className='container mx-auto pb-14 pt-4'>
            <h1 className='text-[10px] color'><Link href='/' className='hover:underline'>home</Link>  <span className="mx-2">{`//`}</span>  <Link href='/services' className='hover:underline'>Our Services</Link>  <span className="mx-2">{`//`}</span>   <span className='yellow-text font-bold '>Email Marketing</span>  </h1>
            <div className='text-5xl pt-8'>

              <h1 className='mt-4 font-[500]'>  Email Marketing<YellowDot />
              </h1>
