        ...
        <Scrolln>
          <div className="container mx-auto lg:px-36 md:px-20 px-10 pb-14 pt-4">
            <h1 className="text-[10px] color">
              ...
              <span className="yellow-text font-bold">about</span>{" "}
            </h1>
        ...
        <Scrolln width="100%">
          <div className="container mx-auto">
            <h1 className="dot-title lg:leading-[90px] text-center lg:text-7xl text-4xl zinc-text mx-auto lg:w-8/12  font-medium mx-auto ">
              Catalyzing your digital dreams into reality, one innovation at a
              time
            </h1>
          </div>
        </Scrolln>
        ...
        <Scrolln width="100%">
          <div className="container mx-auto">
            <h1 className="dot-title text-4xl font-[600] lg:w-8/12 mx-auto md:w-10/12 w-full">
              Crafting Seamless Customer Journeys, Igniting Your Business
              Success
            </h1>
            <p className="text-xl w-11/12  md:w-7/12  mx-auto mt-10">
              At TechSavy Group, we specialize in crafting seamless customer
              journeys that ignite your business success. Our purpose is to keep
              your customers flowing smoothly along the path to purchase,
              ensuring your business thrives in the digital landscape. Discover
              how we can transform your customer flow and drive exceptional
              results.
            </p>
